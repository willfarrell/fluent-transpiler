...
// ## Placeables
export const replaceParam = (params) =>
	`param: ${__formatVariable(params?.string)} | ${__formatVariable(params?.integer)} | ${__formatVariable(params?.decimal)} | ${__formatVariable(params?.number)} .`;
const term = `Firefox`;
...
export const parameterizedTerms = (params) =>
	`Informacje o ${brandName({ ...params, case: "locative" })}.`;
...
export const messageNestedParamValue = (params) =>
	`message: ${replaceParam(params)}`;
// ## Special Characters
...
// ## Functions
export const timeElapsed = (params) =>
	`Time elapsed: ${__formatNumber(params?.number, { maximumFractionDigits: "0" })}s.`;
export const todayIs = (params) =>
	`Today is ${__formatDateTime(params?.date, {})}`;
// ## Selectors
export const selectorNumberCardinal = (params) =>
	`${__select(
		params?.number,
		{
...
export const selectorNumberOrdinal = (params) =>
	`${__select(
